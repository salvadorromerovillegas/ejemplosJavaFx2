 ...
 * usando un mismo manejador para todo, en este caso, como "formato" de
 * función lamda.
 * 
 * @author Salvador Romero
 */
public class Ejemplo7EventHandlerComoLambdaV2 extends Application {

    public static void main(String[] args) {
        
        Application.launch(Ejemplo7EventHandlerComoLambdaV2.class,args);
    }
    
    @Override
    public void start(Stage primaryStage) throws Exception {
        primaryStage.setTitle("Ejemplo 7: Un event handler como función lamda.");
