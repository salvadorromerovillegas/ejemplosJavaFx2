...
public final class BarraView extends HBox {
    ...
    {
         //1º Invocamos al constructor padre.
         super();
         //2º Creamos el texto.
         t=new Text(String.format("Ancho %d: ",(int)ancho));            
         //3º Añadimos el rectángulo.
         r=new Rectangle(ancho,alto,Color.GREEN);
         //4º Añadimos el manejador para cambiar a azul
         r.setOnMouseEntered(rellenarFormaAzul);            
         //5º Añadimos el manejador para cambiar a verde
         r.setOnMouseExited(rellenarFormaVerde);
         //6º Añadimos el manejador para cambiar de tamaño
         this.setOnMouseClicked(aumentarDeTamañoRectangulo);
         //Añadimos varios nodos a la vez.
